...
export default function BodySection6(){
    ...
    const fetchData = async ()=>{
        const response = await axios.get('https://ranking-game-vttt.vercel.app/xmlTest/XMLFILE.xml');
    ...
    return(
        <div className='bodySection6-Container'>
            <div>
                ...
                <h6 data-aos-duration="800"  data-aos="zoom-in" className='fs-1 text-center'>
                    Our Gaming Magazine
                </h6>
            </div>
